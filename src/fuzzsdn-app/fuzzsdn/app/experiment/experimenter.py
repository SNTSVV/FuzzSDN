...
import fuzzsdn.resources.criteria
from fuzzsdn.app import setup
from fuzzsdn.app.experiment import Analyzer, RuleSet, strategy
...
class Experimenter:
    ...
    def scenario(self, value: Union[str, Tuple[str, dict]]):
        ...
        scenario_pkg = "fuzzsdn.resources.scenarios.{0}.{0}".format(name)
        try:
    ...
    def criterion(self, value: Union[str, Tuple[str, dict]]):
        ...
        try:
            # Load the criteria
            criterion = resources.read_text(fuzzsdn.resources.criteria, criterion_file_name)
