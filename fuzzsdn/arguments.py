# -*- coding: utf-8 -*-
"""
Module used to parse the arguments of fuzzsdn-report
"""
...
from fuzzsdn.common.utils import str_to_typed_value, time_parse
from fuzzsdn import __version__, __app_name__
from fuzzsdn.common.utils import StrEnum
from fuzzsdn.resources import scenarios, criteria


# ===== ( Enums ) ======================================================================================================

class Command(StrEnum):
    """Enum for the possible commands of fuzzsdn."""
...
class FailureToTestType(StrEnum):
    """Enum for the possible failures to test type of fuzzsdn."""
